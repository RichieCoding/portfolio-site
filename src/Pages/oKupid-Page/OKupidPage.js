    ...
    <div className='okupid-page'>
      ...
      <div className='okupid-header'>
        <div className='main-header'>
          <h3>oKupid</h3>
          <p>A dating app where you can create your profile, browse other users, give them a follow, message them. There is also a matching feature that matches you with other users based on your profile information.</p>
        </div>
